...
*------------------------------------------------------------------------------- 
	...
	* Consumption in usd
	global usd 0.00037
	*this is a global, which means if the exchange rate changes in future, it can always be changed
	...
	// Exercise 3: Handle outliers ----
		// you can use custom Winsorization function to handle outliers. CODE FROM LECTURE NOTES: winsor x, p(0.05) high gen(y)
...
*------------------------------------------------------------------------------- 	
	...
	*Not dropping anything currently
...
*------------------------------------------------------------------------------- 	
	...
	// Exercise 5: Merge HH and HH-member data ---- Using 1-to-1 because it's household level
		// Instructions:
...
*------------------------------------------------------------------------------- 	
	...
	lab var n_medical "Number of medical facilities"
